...
def biseccion_esfera(intervalo,niter,tolerancia,function_circulo,v,a):
    ...
    if fxi_circulo == 0:return[xi,yi.zi]
    elif fxf_circulo == 0:return [xf,yf,zf]
        ...
        if fxm_circulo == 0:return [xm,ym,zm]
        elif error < tolerancia:return[xm,ym,zm]
        else:print("Fracaso el numero de iteraciones: ",niter)    
